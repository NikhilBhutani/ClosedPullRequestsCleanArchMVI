package com.navi.assignment.ui.customviews;
...
//        }
    ...
    public void hide() {
        ...
        if (diff >= MIN_SHOW_TIME || mStartTime == -1) {
            // The progress_bar spinner has been shown long enough
            // OR was not shown yet. If it wasn't shown yet,
            // it will just never be shown.
            setVisibility(View.GONE);
        } else {
            // The progress_bar spinner is shown, but not long enough,
    ...
    void drawTrack(Canvas canvas) {
        ...
        if (d != null) {
            // Translate canvas so a indeterminate circular progress_bar bar with padding
